...
plot(running_mean(samples_k_ackley[,1]), type = "l", main = "Running Mean for k_ackley dim1", xlab = "Iteration", ylab = "Mean")
...
hist(samples_k1, breaks = 50, main = "Density for k1", xlab = "Theta", freq = FALSE)
curve(k1, from = -7, to = 7, add = TRUE, col = "red", lwd = 2)
acf(samples_k1, main = "ACF for k1")
plot(running_mean(samples_k1), type = "l", main = "Running Mean for k1", xlab = "Iteration", ylab = "Mean")
mean(samples_k1)
...
# Running mean plots
plot(running_mean(samples_banana[, 1]), type = "l", main = "Running Mean for Theta1", xlab = "Iteration", ylab = "Mean")
